...
/*
	- Implement adding elements to a slice
	- Implement removing elements from a slice
	- Execute decomposition for arrays and slices using the spread operator
	- Monitor the presence of a key in a map with the blank identifier idiom
	- Execute reading the value of a key in a map using the "comma ok" syntax
	- Implement built-in collection functions including len.
*/
